...
FOR /F "usebackq delims=" %%i IN (`^""%JAVA%" --module-path "%AS_INSTALL%\lib\gf-client.jar;%AS_INSTALL%\lib\bootstrap" --add-modules ALL-MODULE-PATH org.glassfish.appclient.client.acc.agent.CLIBootstrap^"`) DO set CMD=%%i
%CMD%
